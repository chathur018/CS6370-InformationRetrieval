...
class SearchEngine:
	...
	def doSpellChecking(self, text):
		"""
		Call the required spell Checker
		"""
		return self.spellChecker.spellCheck(text)
	...
	def preprocessDocs(self, docs):
		...
		for doc in stopwordRemovedDocs:
			spellCheckedDoc = self.doSpellChecking(doc)
			spellCheckedDocs.append(spellCheckedDoc)
		json.dump(spellCheckedDocs, open(self.args.out_folder + "spell_checked_docs.txt", 'w'))
		"""
